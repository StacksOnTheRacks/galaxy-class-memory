...
current_focus: "Control plane baseline shipped (#1–#4 Done, PRs #5–#8). Game authentication in Refinement (#9–#13): registry, key validation, probe route, SDK, docs."
major_components:
  ...
  - "Game registry (in flight #9) — DynamoDB key-hash lookup; ADR-002 at refinement"
