...
current_focus: "Control plane baseline shipped (#1–#4 Done, PRs #5–#8). #9–#12 Ready (ai-ready): registry, auth, probe route, TypeScript SDK. #13 Refinement: integrator docs."
major_components:
