...
Board/SCM wins — reconcile against GitHub project board on grooming. #1–#4 Done (PRs #5–#8). #9–#10 Ready (ai-ready); #11–#13 Refinement on game auth milestone. Host attach + match primitives remain icebox.
