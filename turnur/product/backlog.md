...
Board/SCM wins — #1–#13 Done (PRs #5–#18). Host attach [#19–#23](https://github.com/StacksOnTheRacks/turnur/milestone/2) in Refinement on [Host attach a match](https://github.com/StacksOnTheRacks/turnur/milestone/2). Match primitives + signed result remain icebox.
