...
Board/SCM wins — #1–#13 Done (PRs #5–#18). #19–#20 Ready (ai-ready); host attach [#21–#23](https://github.com/StacksOnTheRacks/turnur/milestone/2) remain in Refinement on [Host attach a match](https://github.com/StacksOnTheRacks/turnur/milestone/2). Match primitives + signed result remain icebox.
