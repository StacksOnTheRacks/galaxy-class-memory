...
current_focus: "play-lab LLD — HLD complete; next /forge.backlog-grooming to split into LLD tickets (host match.create, lab orchestrator, capability postMessage). playable-holdem-table continues executing."
major_components:
