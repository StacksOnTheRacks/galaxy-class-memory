...
watch_list:
  ...
  - "Missing play-lab shell frames on Screens / Flows blocks designer HLD exit for play-lab (user_facing); felt frames exist — lab chrome needs /forge.design-spike"
