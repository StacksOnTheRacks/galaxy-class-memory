...
interfaces:
  ...
  - "Host → Riffle runtime — POST /v1/seats/capability/mint Bearer host API key; body { matchId, seatId, playerSubject }; 200 { token, expiresIn: 900, jti }; client presents X-Riffle-Seat-Capability; requireSeatCapability verifies before seat-scoped ops; postMessage is not authority"
