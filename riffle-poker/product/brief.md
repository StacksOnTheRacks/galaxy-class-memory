...
current_focus: "Now: standalone-play-and-embed #44 remaining in Refinement (#36–#43 Done). Artwork split into Refinement tickets (#53–#58) this grooming. Shipped: playable-holdem-table #1–#9, play-lab #19–#24 (Turnur-backed; historical). Next (operator-locked): Web Site; Complete NLHE Hand; Multi-Hand Session."
---
