...
Board/SCM wins — #1–#4 Ready; #5–#9 remain on Refinement under [milestone/1](https://github.com/StacksOnTheRacks/riffle-poker/milestone/1). Icebox is coarse outcomes only (Next/Later); do not treat these as tickets.
