...
schema_version: 1
updated: 2026-08-23
objective: "Ship the remaining host Chrome MV3 host control panel MVP so hosts stay on the party tab, open/navigate the media tab, browse the public catalog, and change room title from the panel. Capture stays in the SPA."
in_scope:
...
sequence:
  ...
  - "Open/navigate host media tab without leaving the party tab — https://github.com/StacksOnTheRacks/riffsync/issues/428 (Ready, ai-ready)"
  - "Host control panel catalog library (B1) — https://github.com/StacksOnTheRacks/riffsync/issues/429 (Ready, ai-ready)"
  - "Title change via host PATCH + media navigate (A1), JWT A, now playing — https://github.com/StacksOnTheRacks/riffsync/issues/430 (Ready, ai-ready)"
  - "Docs: unpacked install + host control panel hosting flow — https://github.com/StacksOnTheRacks/riffsync/issues/431 (Ready, ai-ready)"
  - "Epic #426 Done when #427–#431 are Done — https://github.com/StacksOnTheRacks/riffsync/issues/426"
  - "Later: Official Live channels and deeper host/ops bets as product picks them"
dependencies:
...
Reconcile sequence against board — project/status reports #427–#431 Done.
