...
current_focus: "Shipped baseline: host Chrome MV3 extension (ADR-001) at apps/host-extension is a tabs/media helper; party Room tab is the host control panel; Official Live at /live/:slug; TV client with Cast and Link TV. No open delivery slice; board empty."
major_components:
