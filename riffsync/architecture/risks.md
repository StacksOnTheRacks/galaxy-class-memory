...
- Extension couples to: public catalog GET, host room PATCH (`catalogEpisodeId`), SPA JWT bridge, and host source URL rules aligned with SPA `resolveHostSourceTabUrl` / named media browsing context.
